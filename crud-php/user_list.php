...
<body>
	<div class="container" style="margin-top:20px;">
		<div class="jumbotron" style="background-color:green">
			<h1 style="align:middle;color:white">Lab test on CRUD</h1>
			<p style="color:white">The code written by <b style="color:black;">Robiul Hasan </b> with html, css, boostrap, php and mysql with responsive design</p>
		</div>
		<table class="table">
			<thead>
				<tr>
